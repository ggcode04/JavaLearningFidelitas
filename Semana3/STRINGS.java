...
public class StringPractica {
    ...
    public static void main(String[] args) {
        ...
        sCuidadTienda = JOptionPane.showInputDialog("Ingre la ciudad y tienda");
        sCuidadTienda = sCuidadTienda.trim(); //elimino espacios al inicio y al final
        nPosicionEspacioFinal = sCuidadTienda.lastIndexOf(" "); // encuentra la posicion donde termina el caracter especifico
        nPosicionEspacio = sCuidadTienda.indexOf(" "); // encuentra la posicion donde comienza el caracter especifico
        sTienda = sCuidadTienda.substring(nPosicionEspacioFinal + 1); //devuelve la posicion del segundo string despues del delimitador
        sCuidad = sCuidadTienda.substring(0, nPosicionEspacio); //devuelve la posicion del primer string antes del delimitador
        ...
        sCuidadTiendaNuevo  = sCuidad.toUpperCase() + " " + sTienda.toLowerCase(); //asignacion del concatenado de los dos textos
        ...
        // Validación de que si los dos strings son iguales despues de aplicar mayusculas minisculas y split de caracteres
